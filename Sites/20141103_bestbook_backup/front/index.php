...
<div class="container">
    <div class="publish">
            <a href="#">
                ...
                data-lg-src="../assets/css/img/index/publish_lg.jpg"
                data-md-src="../assets/css/img/index/publish_md.jpg"
                data-sm-src="../assets/css/img/index/publish_sm.jpg"
                >
            </a>
        </div>
    <div class="theme">
            ...
            <?php $index = 0; foreach ($products as $key => $value) {　?>
                <li>
                    <div class="bookItem">
                        ...
                        <?php if($index==0){?>
                            <img src="../assets/css/img/frame/ipad_balck.png" alt=""/>
                        <?php }else{?>
