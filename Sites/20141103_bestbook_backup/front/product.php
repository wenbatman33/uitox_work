        ...
        <div class="row">
            ...
            <figure itemscope itemtype="http://data-vocabulary.org/Product">
                ...
                <div class="bookWrap">
                    <div class="bookItem">
                        <div class="ipadFrame">
                        <img src="../assets/css/img/frame/ipad_white.png" alt="">
                        </div>
                        <div class="ipadInner">
                        <img src="../assets/css/img/sample/book_01.jpg" title="完美" alt="完美">
                        </div>
                    </div>
                </div>
                <figcaption>
                    <h1 itemprop="name">解憂雜貨店 - ナミヤ雑貨店の奇蹟</h1>
                    <p class="subtitle">解憂雜貨店</p>
                    <ul class="feature">
                    ...
                    <div class="buy">
                        ...
                        <a href="#" class="button large green">加入書櫃</a>
        ...
        <div class="row">
            <div class="relate">
                ...
                <ul class="bookcase">
                    ...
                    <li>
                        <div class="bookItem">
                            <div class="ipadFrame"><a href="../front/product.php"><img src="../assets/css/img/frame/ipad_white.png" alt=""/></a></div>
                            <div class="ipadInner">
