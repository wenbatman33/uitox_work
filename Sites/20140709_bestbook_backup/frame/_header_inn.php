<header class="header-inn">
    <div class="container">
        ...
        <div class="main-category">
            <div class="icon-menu">
                <span class="menu-txt">分類</span>
            </div>
            <div class="category-mask">
                <ul class="category-item icon-category-arrow">
                    <li>
                        <a href="../front/category.php">文學小說</a>
                        <a href="../front/category.php">最新上載</a>
                        <a href="../front/category.php">暢銷閱讀</a>
                        <a href="../front/category.php">心靈勵志</a>
                        <a href="../front/category.php">翻譯小說</a>
                        <a href="../front/category.php">翻譯小說</a>
                    </li>
                    <li>
                        <a href="../front/category.php">商業理財</a>
                        <a href="../front/category.php">最新上載</a>
                        <a href="../front/category.php">暢銷閱讀</a>
                        <a href="../front/category.php">企業經營</a>
                        <a href="../front/category.php">電腦技能</a>
                        <a href="../front/category.php">電腦技能</a>
                    </li>
                    <li>
                        <a href="../front/category.php">藝術設計</a>
                        <a href="../front/category.php">最新上載</a>
                        <a href="../front/category.php">暢銷閱讀</a>
                        <a href="../front/category.php">設計概論</a>
                        <a href="../front/category.php">電腦動畫</a>
                        <a href="../front/category.php">電腦動畫</a>
                    </li>
                    <li>
                        <a href="../front/category.php">人文史地</a>
                        <a href="../front/category.php">最新上載</a>
                        <a href="../front/category.php">暢銷閱讀</a>
                        <a href="../front/category.php">社會科學</a>
                        <a href="../front/category.php">哲學心理</a>
                        <a href="../front/category.php">哲學心理</a>
                    </li>
                    <li>
                        <a href="../front/category.php">自然科學</a>
                        <a href="../front/category.php">最新上載</a>
                        <a href="../front/category.php">暢銷閱讀</a>
                        <a href="../front/category.php">人文科學</a>
                        <a href="../front/category.php">圖鑑百科</a>
                        <a href="../front/category.php">圖鑑百科</a>
                    </li>
                </ul>
            </div>
