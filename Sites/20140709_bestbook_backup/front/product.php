...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/shop/product.css">
    <!--[if lt IE 9]>
...
<body>
    ...
    <div class="main-product container">
        ...
        <div class="row">
            ...
            <figure itemscope itemtype="http://data-vocabulary.org/Product">
                ...
                <figcaption>
                    ...
                    <div class="buy">
                        <div itemprop="price" class="price"><span class="currency">$</span>4,390</div>
                        <a href="#" itemprop="offerurl" class="button large full">直接購買</a>
                        <!-- <a href="#" class="button large orange">免費閱讀</a> -->
                        <a href="#" itemprop="offerurl" class="button large full red">加入購物車</a>
                        <a href="#" itemprop="offerurl" class="button large">線上試閱</a>
        ...
        <div class="row">
            <div class="buy center buy_sub">
                <span itemprop="price" class="price"><span class="currency">$</span>4,390</span>
                <a href="#" itemprop="offerurl" class="button large full">直接購買</a>
                <!-- <a href="#" class="button large orange">免費閱讀</a> -->
                <a href="#" itemprop="offerurl" class="button large full red">加入購物車</a>
                <a href="#" itemprop="offerurl" class="button large">線上試閱</a>
        ...
        <div class="bottom-buy">
            <ul>
                <li><div class="price">$199</div></li>
                <li><a href="#" class="icon-bottom-buy"></a></li>
                <li><a href="#" class="icon-bottom-try"></a></li>
                <li><a href="#" class="icon-bottom-next"></a></li>
                <!-- <li><a href="#" class="icon-bottom-read"></a></li>
                <li><a href="#" class="icon-bottom-list"></a></li> -->
            </ul>
        </div>
    </div>
