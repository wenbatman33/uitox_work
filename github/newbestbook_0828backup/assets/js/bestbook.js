$(function() {
	...
	$('.youtubemMov').on('click', function(){
		if( $('.movMODAL').hasClass('is-visible') ) {
			...
			$('.movMODAL .inner .innerMOV').html("<iframe class='YT' id='BBMov' src='https://www.youtube.com/embed/ggWNnVdxNms?autoplay=1&hd=1&vq=hd720' frameborder='0' allowfullscreen></iframe>");
